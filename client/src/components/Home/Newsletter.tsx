...
const Newsletter = () => {
  return (
    ...
    <section className="bg-white py-18 px-4 sm:px-6 lg:px-8 rounded-3xl mx-auto shadows-xs mt-32 mb-20">
        <div className="max-w-2xl mx-auto text-center">
            <div className="max-w-2xl mx-auto text-center">
                ...
                <p className="text-app-text-light mb-8 text-base">Get weekly updates on fresh produce and special offers!</p>
