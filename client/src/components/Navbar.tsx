import { ArrowRightIcon, ArrowUpRightIcon, BikeIcon, ChevronDownIcon, LogOutIcon, MapPinIcon, MenuIcon, PackageIcon, SearchIcon, ShieldIcon, ShoppingCartIcon, UserIcon, XIcon } from "lucide-react";
        ...
        <div className="w-full flex items-center justify-end gap-4 lg:gap-10">
            ...
            <div className="flex items-center gap-3">
                ...
                <button className="relative p-2 rounded-xl" onClick={() => setIsCartOpen(true)}>
                    ...
                    {cartCount > 0 && (
                        <span className="absolute -top-1 -right-1 bg-app-orange text-white text-[10px] rounded-full flex items-center justify-center size-4">
                            {cartCount}
                        </span>
                    )}
                </button>
